...
-s tests` **collects 2,779 cases in 91 modules** as of 2026-09-19 (how many pass is what the command
...
| `tests/test_update.py` | 13 | scripts/relay-update.py decides, offline, which package a machine takes |

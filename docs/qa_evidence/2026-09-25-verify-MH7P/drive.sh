#!/usr/bin/env bash
set -uo pipefail
EV=/home/elliott/repos/relay-terminal/docs/qa_evidence/2026-09-25-verify-MH7P
...
sleep 4
import -window root "$EV/01-models-pane.png"
xdotool key alt+q
sleep 5
import -window root "$EV/02-altq-console.png"

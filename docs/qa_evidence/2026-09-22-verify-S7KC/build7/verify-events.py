...
check('interrupt_exit_130',find('sleep 20')['exit_status']==130)
check('cancelled_command_not_dispatched',not any('CANCELLED_MUST_NOT_RUN' in x['command'] for x in history))

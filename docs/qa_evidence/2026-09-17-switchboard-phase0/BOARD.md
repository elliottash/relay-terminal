...
57 cards. Format: [docs/SWITCHBOARD-FORMAT.md](../docs/SWITCHBOARD-FORMAT.md).
...
| `#7KEA` | [Model roles in settings: main, fast, terminal-use, subagent, Switchboard, chores, vision](features/2026-09-17-model-roles-and-fast-agent.md) | ready |  |  |  |

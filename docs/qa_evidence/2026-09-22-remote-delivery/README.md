...
Re-verified on 2026-09-24 by a terminal pane running #PRM2: the codex changes are fully on main as a3594364, so nothing was re-implemented. From main at 80c727bf, all three commands above pass again (sharing + remotesettings 2/2, test_remote_gui_host 51 tests OK, run.py PASS; pairing.png regenerated by this run).

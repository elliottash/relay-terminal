...
sleep 1
import -window root -crop 1400x900+0+0 "$evidence_dir/01-compass.png"
xdotool key Right Right Down
sleep 1
import -window root -crop 1440x900+0+0 "$evidence_dir/02-remote-menu.png"
xdotool key Escape
xdotool windowsize "$window_id" 520 700
sleep 1
import -window root -crop 520x700+0+0 "$evidence_dir/03-narrow.png"
printf 'captured Compass evidence in %s\n' "$evidence_dir"

...
* a request whose system prompt names a coding session is the title side call (protocol 17.1);
* a request whose system prompt labels a tab is the tab_label call (protocol 17.3).

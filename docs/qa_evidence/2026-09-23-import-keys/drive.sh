...
out=$root/docs/qa_evidence/2026-09-23-import-keys
sandbox=$(mktemp -d /tmp/relay-k7mp-XXXXXX)
display=:888
...
for n in $(seq 1 28); do xdotool click 5; sleep 0.08; done
sleep 2
import -window root "$out/01-import-at-bottom.png"
xdotool mousemove 1483 793 click 1
sleep 2
import -window root "$out/02-source-chooser.png"
xdotool mousemove 902 404 click 1
sleep 1
import -window root "$out/03-import-sources.png"

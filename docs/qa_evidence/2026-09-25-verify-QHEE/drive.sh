#!/usr/bin/env bash
set -uo pipefail
EV=/home/elliott/repos/relay-terminal/docs/qa_evidence/2026-09-25-verify-QHEE
...
for i in $(seq 1 20); do xdotool click 5; sleep 0.1; done
sleep 2
import -window root "$EV/01-sources-local-group.png"

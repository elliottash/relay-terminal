...
root=Path('/home/elliott/repos/relay-terminal'); out=Path('/tmp/mdl1-real3-evidence'); out.mkdir(exist_ok=True)
home=Path('/tmp/mv-real3-auth'); home.mkdir(exist_ok=True)

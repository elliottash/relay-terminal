...
| Warp | #7199 (closed) "WARP.md and Agent Rules are ignored once the context window is reached or after summarization"; #7408 plan and subagent tracking breaks after a few subtasks | forgotten rules and plans | — |

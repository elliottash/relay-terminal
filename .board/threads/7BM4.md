...
<!-- relay:entry 20260925T180520Z-3h author=agent kind=evidence -->
Check · 5 missing-evidence, 4 not-applicable, 2 passed; 11 advisory finding(s). The status is under `## Tests`; earlier checks are in this thread.

<!-- relay:entry 20260925T181020Z-w5 author=agent kind=evidence -->
Check · 5 missing-evidence, 4 not-applicable, 2 passed; 11 advisory finding(s). The status is under `## Tests`; earlier checks are in this thread.

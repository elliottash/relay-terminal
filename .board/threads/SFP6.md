...
<!-- relay:entry 20260924T043018Z-pn author=owner kind=comment mode=plan -->
Plan this card.

<!-- relay:entry 20260924T043018Z-po author=owner kind=event pane=switchboard -->
- ✦ owner moved this card · Inbox → Planning · a Plan turn started

<!-- relay:entry 20260924T043155Z-ek author=agent kind=event model=kimi-k3 pane=switchboard turn=6a43eda89c07c008551f9b54f0adbcae/7126246b03f74ae8b8ee40ec1da1eab0 -->
- ✦ agent updated this card · replaced `## Done means`

<!-- relay:entry 20260924T043221Z-dz author=agent kind=event model=kimi-k3 pane=switchboard turn=6a43eda89c07c008551f9b54f0adbcae/7126246b03f74ae8b8ee40ec1da1eab0 -->
- ✦ agent updated this card · replaced `## Plan`

<!-- relay:entry 20260924T043230Z-1s author=agent kind=comment mode=plan model=kimi-k3 turn=6a43eda89c07c008551f9b54f0adbcae/7126246b03f74ae8b8ee40ec1da1eab0 -->
I'll read the card fresh and look at the code it names.
...
**Planned #SFP6.** The fix is a two-line rewording: both raise sites of "File exceeds the 128 KiB preview/read limit." in `backend/relay_core/tools.py` (`Workspace.read_bytes:476`, `_as_text:1257`) get one shared message that names `run_command` as the way out, plus a test in `tests/test_tools.py`. Nothing it needs from you — press **Run** when you want it executed. (The dimmed-✗ rendering stays with #25XG.)

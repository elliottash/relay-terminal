...
<!-- relay:entry 20260924T182411Z-y8 author=agent kind=note model=claude-opus-5-5 pane=31017c4c turn=e68a511fa83e45db8686dee37a7ac070/650f2f7567c049909a48c55820fc51ae -->
Owner asked to remove the "open sortable table" row under agent Markdown tables; done in 93ca678 under #15G5. `relay show file.csv` tables are unchanged. The verifier should skip the Markdown-table chip check in the inline-media evidence (docs/qa_evidence/2026-09-23-inline-media/drive.sh expects it).

<!-- relay:entry 20260924T183439Z-4w author=agent kind=evidence model=claude-opus-5-5 pane=31017c4c turn=e68a511fa83e45db8686dee37a7ac070/1936ba7491a34bc790847ffca696e112 -->
Owner asked to adjust this card's drive for #15G5; done in 2bbef95. stub-provider.py's table now has a cell wider than the pane; after the restart drive.sh checks that no "Markdown table" manifest exists in the media cache and that the saved scrollback holds the wide row wrapped inside its column with the │ bars aligned. 03-agent-math.png now shows the wrapped table and no sortable row; README row updated. The relay-show CSV row (01, 07) is unchanged. Full drive passed (exit 0) against the land.py verify build of 69ba7b2; 02–06 and 08 were re-taken in that run.

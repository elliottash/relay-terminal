...
<!-- relay:entry 20260924T043215Z-v7 author=owner kind=comment mode=plan -->
Plan this card.

<!-- relay:entry 20260924T043215Z-v8 author=owner kind=event pane=switchboard -->
- ✦ owner moved this card · Inbox → Planning · a Plan turn started

<!-- relay:entry 20260924T043434Z-pk author=agent kind=event model=kimi-k3 pane=switchboard turn=21b32f882477b4c3f12c3f1760ec4d9a/ea0728b170664bd18ba55746acf665a3 -->
- ✦ agent updated this card · replaced `## Done means`

<!-- relay:entry 20260924T043518Z-8w author=agent kind=event model=kimi-k3 pane=switchboard turn=21b32f882477b4c3f12c3f1760ec4d9a/ea0728b170664bd18ba55746acf665a3 -->
- ✦ agent updated this card · replaced `## Plan`

<!-- relay:entry 20260924T043532Z-aw author=agent kind=comment mode=plan model=kimi-k3 turn=21b32f882477b4c3f12c3f1760ec4d9a/ea0728b170664bd18ba55746acf665a3 -->
I have the full picture. Writing `## Done means` first, then the plan.



**Done:** #JXFT is planned. The diagnosis: `start_catalog_scan()`'s daemon thread writes `_catalog`/`_login`, sets `catalog_ready` and fires the listener unconditionally, so a scan left running across a test's `reset_catalog()` lands real `codex debug models` output into the next test — the fix is a generation counter that strands stale scans at every write, plus a deterministic regression test with a blocked mock reader.

Nothing needed from the owner; the plan notes one accepted residual risk (a narrow race between the pre-call check and the call, made harmless by the post-write check) and is ready to Run.

<!-- relay:entry 20260924T043532Z-eg author=owner kind=event pane=switchboard -->

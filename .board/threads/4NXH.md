...
<!-- relay:entry 20260923T223821Z-2b author=agent kind=evidence -->
Check · 3 missing-evidence, 1 not-applicable, 4 passed; 5 advisory finding(s). The status is under `## Tests`; earlier checks are in this thread.

<!-- relay:entry 20260923T223840Z-05 author=agent kind=evidence -->
Check · 3 missing-evidence, 1 not-applicable, 4 passed; 5 advisory finding(s). The status is under `## Tests`; earlier checks are in this thread.

<!-- relay:entry 20260923T231814Z-9q author=agent kind=evidence -->
Check · 2 missing-evidence, 1 not-applicable, 5 passed; 5 advisory finding(s). The status is under `## Tests`; earlier checks are in this thread.

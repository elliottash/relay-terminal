...
links: {plans: [], commits: [f5606d58d763, bf6231c20a65, 5d40b83c2239, 34077c2b2802, b2d455429dea, 6550d71095fc, 4af516ea838c], evidence: [], related: [], github: null}
---
...
Pass: `python3 scripts/land.py try b2-handoff-reason --verify-cmd "PYTHONPATH=backend python3 -m pytest -q tests/test_integration_handoffs.py tests/test_queue.py tests/test_subagents.py"` — exact tree; focused tests cover durable pending reason in the service event log.

...
- not-applicable · unittest:tests.test_user_memory_tools — tests/test_user_memory_tools.py is not in the project any more
...
- missing-evidence · unittest:tests.test_app_tools — no run of tests/test_app_tools.py for this revision, from any host, and no attached result
...
- not-applicable · manual:docs/qa_evidence/2026-09-22-user-memory/ — manual evidence, recorded by hand: docs/qa_evidence/2026-09-22-user-memory/
- notice · unittest:tests.test_user_memory_tools — tests/test_user_memory_tools.py is not in the project any more
...
- notice · unittest:tests.test_app_tools — tests/test_app_tools.py: 86 of 86 never ran here (test_set_list_cancel_and_validate_before_gui, test_writes_off_still_allows_list, test_parses_the_configure_block…)
history: thread
## Execution Summary

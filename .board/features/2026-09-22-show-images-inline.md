...
- missing-evidence · ctest:markdownansi|wordwrap|calllines|outputlinks|windowstate|closedlist'`: — no run of ctest -R markdownansi|wordwrap|calllines|outputlinks|windowstate|closedlist'`: for this revision, from any host, and no attached result
- not-applicable · manual:docs/qa_evidence/2026-09-22-inline-images/` (`drive.sh`, four steps, screenshots above). — manual evidence, recorded by hand: docs/qa_evidence/2026-09-22-inline-images/` (`drive.sh`, four steps, screenshots above).
- notice · ctest:markdownansi|wordwrap|calllines|outputlinks|windowstate|closedlist'`: — ctest -R markdownansi|wordwrap|calllines|outputlinks|windowstate|closedlist'`:: 1 of 4 never ran here (wordwrap)
- warning · manual:docs/qa_evidence/2026-09-22-inline-images/` (`drive.sh`, four steps, screenshots above). — manual evidence docs/qa_evidence/2026-09-22-inline-images/` (`drive.sh`, four steps, screenshots above). is not there
history: thread

...
## Tasks
- [ ] Expose session-bound remote command/file operations through the guest bridge and route them through existing executors. <!-- t:gp -->
- [ ] Generate guest remote context from actual available tools; cover reconnect, disconnect, cancellation and stale calls. <!-- t:0y -->
- [ ] Connect permitted visible-terminal handoff and completion to guest calls, coordinating #S7KC. <!-- t:t9 -->
- [ ] Add bridge/adapter regression tests and live-drive the reported large-files request against remote fixtures. <!-- t:dk -->

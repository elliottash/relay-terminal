...
- [ ] the models pane: providers / available / priorities tabs, opened by Ctrl+Shift+M beside the active pane (again closes; Esc returns focus), first run opens with it at the right; Ctrl+Alt+M and the modal go <!-- t:a11 -->

...
links: {plans: [], commits: [], evidence: [docs/qa_evidence/2026-09-20-phone-remote-research/], related: [W5N2, 0VT4, 97EG, T4BS, JQ7R, KBFT, WMXN, GT7X, PF4K], github: null}
---
...
- [ ] Phase 1.4 `rendezvous/deploy.sh`, deployed; served app equals main; PNG icons <!-- t:a4 -->
- [ ] Phase 2.5 Inbox status chips, needs-you order, badge <!-- t:b5 -->
- [ ] Phase 2.6 Stop, Recap (#WMXN), question rows, `full` admits and decides (waits on question 6) <!-- t:b6 -->
- [ ] Phase 2.7 Offline queue and replay; reconnect on pageshow <!-- t:b7 -->
- [ ] Phase 2.8 Two notification switches; tap opens the pane; "check in from your phone" <!-- t:b8 -->

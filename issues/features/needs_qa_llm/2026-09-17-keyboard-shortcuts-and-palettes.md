...
- **Palettes:** Ctrl+Shift+A agent options and Ctrl+Shift+T terminal options float over the right edge, filter as you type, show shortcuts, mark current values, and return focus where it was.

...
links: {plans: [], commits: [], evidence: [docs/qa_evidence/2026-09-21-website-refresh/README.md], related: [K13B, P4GP], github: null}
---
...
## Execution Summary
Updated the website for committed model switching, embedded agent consoles, recaps, approvals, phone pairing and phone Switchboard features since `58aeb17f`. Added a dated development section that distinguishes main from packaged releases. Corrected privacy and board-folder claims; shared the theme controls with Relay Free; preserved all mobile navigation links and improved keyboard radio behavior. Existing screenshots are explicitly labeled as earlier betas.

...
457 cards. Format: [docs/BOARD-FORMAT.md](../docs/BOARD-FORMAT.md).
...
| `#4BPE` | [Model picking: one name per model, one row per model, one default](features/2026-09-21-model-picking-one-name-one-row-one-default.md) | needs-verification | claude-code | 16/16 | [46](threads/4BPE.md) |
...
| `#Y2MP` | [Memory cards that are actually read, and a Switchboard HQ for what is global](features/2026-09-20-memory-cards-that-are-actually-read-and-a-switch.md) | needs-verification | codex |  | [4](threads/Y2MP.md) |
...
| `#R8PK` | [Restore the open Switchboard card](features/2026-09-21-restore-switchboard-card.md) | needs-verification | codex |  | [3](threads/R8PK.md) |
...
| `#XP7N` | [Let the agent request to exit planning mode](features/2026-09-21-agent-request-exit-plan-mode.md) | needs-verification | agent |  | [13](threads/XP7N.md) |
...
| `#CTRN` | [A card turn is an ordinary console turn: the last surface that still has its own agent](features/2026-09-21-are-the-terminal-agent-and-switchboard-agent-th.md) | needs-verification | agent |  | [18](threads/CTRN.md) |
...
| `#RG0Z` | [add a "hide until you need me" mode](features/2026-09-21-add-a-hide-until-you-need-me-mode.md) | needs-verification | codex |  | [12](threads/RG0Z.md) |
| `#S53Z` | [i dont want to use # for labels, just card codes.](features/2026-09-21-i-dont-want-to-use-for-labels-just-card-codes.md) | needs-verification | agent | 3/3 | [18](threads/S53Z.md) |
...
| `#GPF7` | [Guest planning test assumes PLAN MODE is the first prompt text](changes/2026-09-21-guest-plan-prefix-test.md) | inbox |  |  | [1](threads/GPF7.md) |

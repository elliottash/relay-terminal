...
SORTS = ("recent", "oldest", "longest", "shortest", "tokens_desc", "tokens", "requests_desc", "requests", "title", "title_desc", "model", "model_desc",
...
class ConversationIndex:
    ...
    **One connection, one lock.** The connection is opened `check_same_thread=False` because the
    ...
    def search(self, query: str = "", *, scope: str = "project", workspace: str | None = None,
        ...
        "tokens_desc"/"tokens" (most/fewest recorded tokens),
        ...
        order = {"recent": "COALESCE(c.updated, 0) DESC", "oldest": "COALESCE(c.updated, 0) ASC",
                 ...
                 "tokens_desc": "c.tokens DESC, COALESCE(c.updated, 0) DESC",
                 "tokens": "c.tokens ASC, COALESCE(c.updated, 0) DESC",

...
EXIT_PLAN_MODE_SPEC = {"type": "function", "function": {
    "name": "exit_plan_mode",
    "description": "Leave plan mode and start executing. Call when the plan is ready: build mode is enabled immediately and implementation continues in the same turn.",
    "parameters": {"type": "object", "properties": {
        "reason": {"type": "string", "maxLength": 250, "description": "What is ready to execute and why planning is complete."}},
        "required": ["reason"], "additionalProperties": False}}}


def validate_exit_args(args) -> str:

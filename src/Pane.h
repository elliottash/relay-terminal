...
private:
    ...
    // One event off the channel. v1 handles the hooks phase's own events (26.3) and the bridge
    // phase's (26.5); `slash` arrives from another phase and is ignored until it lands.
